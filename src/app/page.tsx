    ...
    <main className="min-h-screen flex flex-col items-center justify-between p-4 sm:p-6 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-[#090d16] to-[#04070d]">
      ...
      <header className="w-full max-w-md flex items-center justify-between py-3 border-b border-slate-800/80 mb-6">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h1 className="text-sm font-bold text-white tracking-wide">Campus Biometric</h1>
            <p className="text-[10px] text-emerald-400 font-medium">4-Angle Face Biometrics Portal</p>
          </div>
        </div>

        <Link
          href="/admin"
          className="text-xs text-slate-400 hover:text-slate-200 bg-slate-900 border border-slate-800 px-3 py-1.5 rounded-xl flex items-center gap-1.5 transition"
        >
      ...
      {/* Footer */}
      <footer className="w-full max-w-md text-center py-4 text-[11px] text-slate-500 border-t border-slate-900 mt-6">
        College Face Attendance AI • 4-Pose Centroid Biometric Collection
      </footer>
    </main>
  );
}
